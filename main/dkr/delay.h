...
#define DELAYLINE_LEN           0 //50  // max delay in samples (30000 is 0.625 seconds)
#define DELAY                   0 //40  // init delay (in samples)
#define MIN_DELAY				0 //30		// min delay, in samples
#define DELTA_DELAY				0 //10		// variation step of delay time
