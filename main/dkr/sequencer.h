...
//#define USE_FF_SEQUENCE

//#ifdef USE_FF_SEQUENCE
//#define NUMBER_STEPS 	4*8*8 //128+48+128 //64 //32 //16
//#else
#define DKR_NUMBER_STEPS_DEFAULT 	32 //16
//#endif

#if defined(USE_LOW_SAMPLE_RATE) || defined(USE_FAUX_LOW_SAMPLE_RATE)
//#ifdef USE_FF_SEQUENCE
//#define INIT_TEMPO 		480 //at low sample rate (24k)
//#else
#define DKR_INIT_TEMPO_DEFAULT 		(4*80*2)
//#endif
#else
//#ifdef USE_FF_SEQUENCE
//#define INIT_TEMPO 		240 //at normal sample rate (48k)
//#else
#define DKR_INIT_TEMPO_DEFAULT 		(4*80)
//#endif
#endif
