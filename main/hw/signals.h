...
extern float sample_f[2],sample_mix,volume2,sample_lpf[2];
...
#define ECHO_DYNAMIC_LOOP_STEPS 12
...
#define ECHO_BUFFER_LENGTH (I2S_AUDIOFREQ * 3 / 2)	//1.5 sec, longest delay currently used (default) -> 152340 bytes
//#define ECHO_BUFFER_LENGTH (I2S_AUDIOFREQ)	//1 sec
//#define ECHO_BUFFER_LENGTH (I2S_AUDIOFREQ / 2)	//0.5 sec
//#define ECHO_BUFFER_LENGTH (I2S_AUDIOFREQ / 8)	//0.125 sec
//#define ECHO_BUFFER_LENGTH (I2S_AUDIOFREQ / 4)	//0.25 sec
//#define ECHO_BUFFER_LENGTH (I2S_AUDIOFREQ * 2)	//doesn't fit by 20k
...
#define ECHO_DYNAMIC_LOOP_LENGTH_ECHO_OFF	 	11	//corresponds to what is in echo_dynamic_loop_steps structure as 0
